...
class VersionTest {
        ...
        void updateBruceWayneToJackNapierShouldGetJackNapier() throws JsonProcessingException {
                ...
                given().when().get("/employee/2").then().statusCode(200)
                                .body(containsString("Jack"));
        }

        @Test
        void updateBruceWayneToJackNapierShouldOptimisticLockException()
        ...
        void changeDepartmentClarkToMavelShouldBeGetMavel() throws JsonProcessingException {
                ...
                given().when().get("/employee").then().statusCode(200)
                                .body(containsString("Mavel"));
        }


        @Test
        void changeDepartmentBruceToMavelShouldOptimisticLockException()
                        throws JsonProcessingException {
                ObjectMapper objectMapper = new ObjectMapper();
